...
input_main_menu_error = f'Выберите пункт меню! Число от 1 до {
    len(main_menu)-1}'
...
def confirm_delete_contact(
    x): return f'Вы действительно хотите удалить контакт - {x}? (y/n)'


good_bay = 'Телефонная книга успещно закрыта!'
