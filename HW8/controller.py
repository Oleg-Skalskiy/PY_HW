            ...
            case'7':
                if search_func(text.input_delete_word):
                    ...
                    if view.input_info(text.confirm_delete_contact(confirm_name)).lower() == 'y':
                        ...
                        view.print_message(
                            text.contact_successful_result(name, 2))
            case'8':
